...
class ExampleQuestionsViewContext
  ...
  val showAnswerExampleQuestionsRequestType: Call = ???
  ...
  def summaryListOfExampleQuestions(exportQuestions: ExampleQuestions)(implicit messages: Messages): SummaryList = {
    ...
    val requestTypeRows = Seq(
      summaryListRow(
        ...
        action = (showAnswerExampleQuestionsRequestType, "site.change")
      )
    )

    val showAnswerExampleQuestionsRouteType: Call = ???
    ...
    val routeTypeRows =
      Seq(
        summaryListRow(
          ...
          action = (showAnswerExampleQuestionsRouteType, "site.change")
        )
      )
